    ...
    <body>
        ...
        <form>
            <div>
                ...
                <input id="activeSensorLocal" onclick="activarSensor('<?php echo $_GET["token"] ?>')" 
                       style="margin-top: 5px;" type="button" value="Asociar Huella" />
                <input id="saveChanges" onclick="addUser('<?php echo $_GET["token"] ?>')" 
                       style="margin-top: 5px;" type="button" value="Guardar" />
