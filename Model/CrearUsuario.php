...
$insert = "insert into usuarios (documento, nombre_completo, telefono, pc_serial, fecha_crecion, foto, ext) "
        . "values('" . $_POST['documento'] . "', '" . $_POST['nombre'] . "', '" . $_POST['telefono'] . "', '"
        . "".$_POST['token']."', NOW(), '" . $foto . "', '" . $ext . "')";
//echo $insert;die;
$row = $con->exec($insert);
